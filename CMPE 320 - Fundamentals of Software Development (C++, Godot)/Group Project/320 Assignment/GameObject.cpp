...
GameObject::GameObject(const sf::CircleShape &sprite, sf::Vector2f position, sf::Vector2f velocity = sf::Vector2f(0, 0)) {
    this->sprite = sprite;
    this->position = position;
    this->velocity = velocity;
}

GameObject::GameObject(const sf::CircleShape& sprite, float x, float y, float vx = 0, float vy = 0) {
    this->sprite = sprite;
