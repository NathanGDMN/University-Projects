...
public:
     ...
     */
    GameObject(const sf::CircleShape& sprite, sf::Vector2f position, sf::Vector2f velocity);
    /**
     * GameObject Constructor
     * @param sprite The object's sprite
     ...
     */
    GameObject(const sf::CircleShape& sprite, float x, float y, float vx, float vy);

    /// Gets the object's sprite
    sf::CircleShape getSprite() { return sprite; }
    /// Sets the object's sprite
    void setSprite(const sf::CircleShape& sp) { this->sprite = sp; }
