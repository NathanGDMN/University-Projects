...
/*
	3. Adjust block width and run test for gpu performance. Get results for the following matrix-blockWidth pairs:
		-125x125, 2
		-250x250, 4
		-500x500, 10
		-1000x1000, 20
...
//__global__(GPU) function for matrixMultiplication:
